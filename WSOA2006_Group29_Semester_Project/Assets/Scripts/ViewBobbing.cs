...
public class ViewBobbing : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 inputVector = new Vector3(Input.GetAxis("Vertical"), 0f, Input.GetAxis("Horizontal")); //for the logic used here I watched https://www.youtube.com/watch?v=YtitivM4wiM&t=8s
